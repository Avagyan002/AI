...
print(X.distance_between_points())
print(X.array_sorting())
print(X.getting_intermediate_y())
print(X.getting_appropriate_y())
print(X.getting_real_y())
print(X.getting_epsilon())
